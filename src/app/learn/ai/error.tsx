...
export default function AILessonError({
  error,
  reset,
}: {
    ...
    <>
      ...
      <main className="p-4 pb-8">
        <div className="rounded-card border border-border bg-card p-6 text-center">
          <p className="text-muted mb-4">本节加载失败，请返回重试。</p>
          <div className="flex flex-wrap justify-center gap-3">
            ...
            <Link href="/learn" className="rounded-card border border-primary bg-primary px-4 py-2 text-sm font-medium text-primary-foreground">
              返回学习
            </Link>
          </div>
        </div>
